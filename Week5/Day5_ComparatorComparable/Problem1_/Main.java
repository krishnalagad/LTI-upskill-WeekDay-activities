...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println(
                    "Enter Account details seperated by comma [Account Id,Account Balance,Account Number,status,Account Type,Customer Id]");
            ...
            accountList.add(
                    new Account(Integer.parseInt(arr[0]), Double.parseDouble(arr[1]), arr[2], arr[3], arr[4], arr[5]));
        ...
        if (choice == 1) {
            ...
            System.out.printf("%-20s %-20s %-20s %-20s %-20s %-20s\n", "Account Id", "Account Number",
                    "Account Balance", "Account Type", "status", "Customer Id");

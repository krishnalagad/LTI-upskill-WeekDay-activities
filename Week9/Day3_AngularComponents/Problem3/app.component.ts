  ...
  template: `<div id="product-details">
    ...
    <div id="product-info">
      ...
      <p id="product-description">
        13.84 cm (5.45 inch) HD+ Display,12MP Rear Camera | 5MP Front
        Camera,4000 mAh Li-Polymer Battery,Qualcomm Snapdragon 439 Processor.
        Brand Warranty of 2 Years Available for Mobile and 6 Months for
        Accessories.
      </p>
    </div>
  </div>`,
